...
SELECT DISTINCT DEPARTMENT_NAME AS "학과 명", CATEGORY AS "계열"
FROM TB_DEPARTMENT;
...
--TB_DEPARTMENT에 DEPARTMENT_NO가 001이고 스튜던트에도 001인 스튜던트SSN에 뒷자리시작번호가 2인 ABSENCE_YN이 N인 학생찾기

SELECT TB_DEPARTMENT.DEPARTMENT_NO AS 학과코드, TB_STUDENT.*
FROM TB_STUDENT
...
SELECT TO_CHAR(ENTRANCE_DATE, 'RR"학번"') AS 학번, STUDENT_NAME, STUDENT_SSN, STUDENT_ADDRESS, ABSENCE_YN
FROM TB_STUDENT
